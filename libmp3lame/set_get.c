...
int
lame_get_countFrames(const lame_global_flags * gfp)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	return gfc->countFrames;
}

int
lame_init_countFrames(const lame_global_flags * gfp)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->countFrames = 0;
	return 0;
...
int
lame_set_Vx(lame_global_flags * gfp, double Vn)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->Vx = Vn;
	return 0;
...
double
lame_get_Vx(const lame_global_flags * gfp)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	return gfc->Vx;
}
...
int
lame_set_Qx(lame_global_flags * gfp, double Qn)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->Qx = Qn;
	return 0;
...
double
lame_get_Qx(const lame_global_flags * gfp)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	return gfc->Qx;
}
...
int
lame_set_adbr_norm_ton(lame_global_flags * gfp, double adbrnorm)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_norm_ton = adbrnorm;
	return 0;
}

int
lame_set_adbr_norm_att(lame_global_flags * gfp, double adbrnorm)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_norm_att = adbrnorm;
	return 0;
}

int
lame_set_adbr_norm_min(lame_global_flags * gfp, double adbrnorm)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_norm_min = adbrnorm;
	return 0;
}

int
lame_set_adbr_short_ton(lame_global_flags * gfp, double adbrshort)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_short_ton = adbrshort;
	return 0;
}

int
lame_set_adbr_short_att(lame_global_flags * gfp, double adbrshort)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_short_att = adbrshort;
	return 0;
}

int
lame_set_adbr_short_min(lame_global_flags * gfp, double adbrshort)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_short_min = adbrshort;
	return 0;
}

int
lame_set_adbr_start_ton(lame_global_flags * gfp, double adbrstart)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_start_ton = adbrstart;
	return 0;
}

int
lame_set_adbr_start_att(lame_global_flags * gfp, double adbrstart)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_start_att = adbrstart;
	return 0;
}

int
lame_set_adbr_start_min(lame_global_flags * gfp, double adbrstart)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_start_min = adbrstart;
	return 0;
}

int
lame_set_adbr_stop_ton(lame_global_flags * gfp, double adbrstop)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_stop_ton = adbrstop;
	return 0;
}

int
lame_set_adbr_stop_att(lame_global_flags * gfp, double adbrstop)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_stop_att = adbrstop;
	return 0;
}

int
lame_set_adbr_stop_min(lame_global_flags * gfp, double adbrstop)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->adbr_stop_min = adbrstop;
	return 0;
}

int
lame_set_insane_factor(lame_global_flags * gfp, double insanefactor)
{
    lame_internal_flags *gfc = gfp->internal_flags;
	gfc->insane_factor = insanefactor;
	return 0;
}

int
lame_set_frameAnalysis(lame_global_flags * gfp, int n)
{
    lame_internal_flags *gfc = gfp->internal_flags;
