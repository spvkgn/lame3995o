...
{                       /* primary to write screen reports */
    ...
    static /*@observer@ */ const char *const str =
        ...
        "(alpha " STR(LAME_PATCH_VERSION) ", " __DATE__ " " __TIME__ ")" " extension:o";
#elif LAME_BETA_VERSION
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) " "
        "(beta " STR(LAME_PATCH_VERSION) ", " __DATE__ ")" " extension:o";
#elif LAME_RELEASE_VERSION && (LAME_PATCH_VERSION > 0)
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) "." STR(LAME_PATCH_VERSION) " extension:o";
#else
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) " extension:o";
#endif
...
#if   LAME_ALPHA_VERSION
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) " (alpha " STR(LAME_PATCH_VERSION) ")" " extension:o";
#elif LAME_BETA_VERSION
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) " (beta " STR(LAME_PATCH_VERSION) ")" " extension:o";
#elif LAME_RELEASE_VERSION && (LAME_PATCH_VERSION > 0)
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) "." STR(LAME_PATCH_VERSION) " extension:o";
#else
...
#define P " "
    ...
    static /*@observer@ */ const char *const str =
      ...
      "LAME" STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) P STR(LAME_PATCH_VERSION)  " ext:o"
#else
      "LAME" STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) P  " ext:o"
#endif
      ;
    return str;
}
...
get_lame_tag_encoder_short_version(void)
{
    ...
    "LAME" STR(LAME_MAJOR_VERSION) STR(LAME_MINOR_VERSION) STR(LAME_PATCH_VERSION) "o"
    ;
    return str;
}
