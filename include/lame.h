...
/* special functions for the functional extension */
int CDECL lame_set_adbr_norm_ton(lame_global_flags *, double);
int CDECL lame_set_adbr_norm_att(lame_global_flags *, double);
int CDECL lame_set_adbr_norm_min(lame_global_flags *, double);
int CDECL lame_set_adbr_short_ton(lame_global_flags *, double);
int CDECL lame_set_adbr_short_att(lame_global_flags *, double);
int CDECL lame_set_adbr_short_min(lame_global_flags *, double);
int CDECL lame_set_adbr_start_ton(lame_global_flags *, double);
int CDECL lame_set_adbr_start_att(lame_global_flags *, double);
int CDECL lame_set_adbr_start_min(lame_global_flags *, double);
int CDECL lame_set_adbr_stop_ton(lame_global_flags *, double);
int CDECL lame_set_adbr_stop_att(lame_global_flags *, double);
int CDECL lame_set_adbr_stop_min(lame_global_flags *, double);
int CDECL lame_set_insane_factor(lame_global_flags *, double);
int CDECL lame_set_frameAnalysis(lame_global_flags *, int);
int CDECL lame_set_cvbr(lame_global_flags *, double);
double CDECL lame_get_cvbr(const lame_global_flags *);
int CDECL lame_set_Vx(lame_global_flags *, double);
double CDECL lame_get_Vx(const lame_global_flags *);
int CDECL lame_set_Qx(lame_global_flags *, double);
double CDECL lame_get_Qx(const lame_global_flags *);
